...
public class CellEditor extends JTextField implements TableCellEditor, SelectionListener {
     ...
     *
     * @return true if a change was made, and unless an erroneous formula was
     * entered
     */
...
//						((antlr.TokenStreamRecognitionException)e.getCause()).recog.getMessage();
    ...
    /**
     * Stores the given cell in the editor. Depnding on if editing should be
     * resumed, the text displayed in the editor is either the cell's content or
     * an empty string.
     *
    ...
    protected class StopAction extends AbstractAction {
        ...
        /**
         * Creates an edit stopping action. When the action is invoked the
         * active cell selection is moved the given number of columns and rows.
         *
