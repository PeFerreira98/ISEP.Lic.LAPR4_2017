...
public class ExtensionImportExportText extends Extension {
	...
	public static final String NAME = "Import Export Text";
        ...
        /**
         * Returns the user interface extension of this extension (an instance of the class {@link lapr4.green.s1.ipc.n1130626.importexporttext.ui.UIExtensionImportExportText}).
