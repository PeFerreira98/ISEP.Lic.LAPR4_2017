 ...
 * <p>
 * <b>Requirement</b><p>
 * There should be a new sidebar window to create, edit and remove addresses <p>
 * associated with contacts (individuals or companies). <p>
 * Each address must include: street, town, postal code, city and country. <p>
 * Each contact should have to addresses: the main address and a secondary address. <p>
 * In the case of a Portuguese address the postal code should be validated. <p>
 * It should be possible to import and update the the list of valid Portuguese <p>
