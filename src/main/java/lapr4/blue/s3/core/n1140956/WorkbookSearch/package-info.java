 ...
 * 
 * <b>Analysis</b><p>
 * This option will be placed on sidebar window. The user will be able to input the expression that he wants to search. The result will be displayed on a list with the cell.
 *
